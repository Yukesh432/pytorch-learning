...
def inference_from_checkpoints(checkpoint_dir, char_to_int, int_to_char, n_vocab, start_prompt, generate_length=100):
    """
    ...
    checkpoint_files = [f"{checkpoint_dir}_epoch_{epoch}.pth" for epoch in range(5, 31, 5)]  # Adjust range as needed
...
def main():
    ...
    start_prompt = "i want to"  # Example prompt
    checkpoint_dir = "model_checkpoint"  # Adjust as needed

    inference_from_checkpoints(checkpoint_dir, char_to_int, int_to_char, n_vocab, start_prompt, 100)  # Generate 100 characters
