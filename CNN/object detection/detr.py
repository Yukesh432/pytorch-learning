...
class ObjectDetectionModel:
    def __init__(self, model_name="facebook/detr-resnet-50", revision="no_timm", threshold=0.9):
        # Initialization of the object detection model
